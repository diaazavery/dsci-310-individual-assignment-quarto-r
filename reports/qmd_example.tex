...
packages were used to perform the analysis: \texttt{knitr} (Xie 2014),
\texttt{tidyverse} (Wickham 2017), and Quarto (Allaire et al. 2022).
...
As seen in Figure Figure~\ref{fig-horse-pop}, Ontario, Saskatchewan, and
Alberta\ldots{} have had the highest horse populations in Canada. All
...
\phantomsection\label{tbl-horseStdDev}
\begin{Shaded}
\begin{Highlighting}[]
...
Additionally, note that in Table \textbf{?@tbl-horses-sd} we consider
